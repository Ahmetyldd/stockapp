package com.stockapp.constants;

public class ErrorMessage {

    public static final String GENERAL_SUCCESS_CODE = "10000000000";
    public static final String GENERAL_FAIL_CODE = "10999000000";
    public static final String TY_FAIL_CODE = "20999000000";

    public static final String GENERAL_SUCCESS_MESSAGE = "İşleminiz başarıyla gerçekleşmiştir.";
    public static final String GENERAL_FAIL_MESSAGE = "Beklenmedik bir hata oluştu. Lütfen daha sonra tekrar deneyiniz.";
