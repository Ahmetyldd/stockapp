...
describe("ProductCard", () => {
    ...
    it("should render edit and delete buttons", () => {
        const wrapper = mountWithStore(
            <ProductCard perfume={mockProduct} colSpan={8} edit={true} onOpenDelete={jest.fn()} />
        );
    ...
    it("should render add to cart button", () => {
        const wrapper = mountWithStore(
            <ProductCard perfume={mockProduct} colSpan={8} edit={false} onOpenDelete={jest.fn()} />
        );
    ...
    it("should click onClickAddToCart", () => {
        ...
        const wrapper = mountWithStore(
            <ProductCard perfume={mockProduct} colSpan={8} edit={false} onOpenDelete={mockOnOpenDelete} />
        );
    ...
    it("should click onOpenDelete", () => {
        const mockOnOpenDelete = jest.fn()
        const wrapper = mountWithStore(
            <ProductCard perfume={mockProduct} colSpan={8} edit={true} onOpenDelete={mockOnOpenDelete} />
        );
