...
import perfumesSlice, { ProductsState } from "./redux-toolkit/perfumes/perfumes-slice";
import perfumeSlice, { ProductState } from "./redux-toolkit/perfume/perfume-slice";
...
export interface RootState {
    ...
    order: OrderState;
    orders: OrdersState;
    perfume: ProductState;
    perfumes: ProductsState;
    user: UserState;
}
