...
describe("Product", () => {
    ...
    const mockStore = {
        ...mockRootStore,
        perfume: { ...mockRootStore.perfume, perfume: mockFullProductResponse, reviews: mockReviews }
    };
    ...
    it("should render correctly", () => {
        ...
        expect(wrapper.find(ProductInfo).prop("perfume")).toBe(mockFullProductResponse);
    ...
    it("should render error message", () => {
        const mockStore = {
            ...mockRootStore,
            perfume: { ...mockRootStore.perfume, loadingState: LoadingStatus.ERROR, errorMessage: "Product not found." }
        };
        const wrapper = mountWithStore(<Product />, mockStore);
    ...
    it("should unmount Product", () => {
        const wrapper = mountWithStore(<Product />);
        wrapper.unmount();
        expect(mockDispatchFn).nthCalledWith(3, { type: "perfume/resetProductState" });
    });
});
