...
alter table if exists order_item add constraint FKst073lwr6yongjsmgaravadre foreign key (product_id) references TYProduct;
...
alter table if exists product_reviews add constraint FK7k3k0ru1omu7xdtdamtrl276 foreign key (product_id) references TYProduct;
