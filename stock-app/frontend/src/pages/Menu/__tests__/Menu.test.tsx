...
describe("Menu", () => {
    ...
    it("should render perfumes list", () => {
        const mockState = {...mockRootStore, perfumes: {...mockRootStore.perfumes, perfumes: mockProductsResponse}};
    ...
    it("should change pagination with search value", () => {
        const wrapper = mountWithStore(<Menu />);
        wrapper.unmount();
        expect(mockDispatchFn).nthCalledWith(2, { type: "perfumes/resetProductsState" });
    });
