...
public class PathConstants {
    ...
    public static final String API_V1_PERFUMES = API_V1 + PRODUCTS;
    ...
    public static final String GETALL_PRODUCT_BYCOMPANY_ANDSTATUS =  "/getAllProductByCompanyAndStatus";
    public static final String GETALL_PRODUCT_BYCOMPANY = "/getAllProductByCompany";
    ...
    public static final String GRAPHQL_PERFUMES = GRAPHQL + PRODUCTS;
